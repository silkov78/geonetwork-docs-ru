...
Эта конфигурация используется приложением для доступа к Интернету для получения онлайн-ресурсов, например, в рамках процесса сбора данных.
...
- используются статусы состояния рабочего процесса (см. [Жизненный цикл](../../user-guide/workflow/life-cycle.md))
