...
(см. [Сбор фрагментов метаданных для поддержки повторного использования](../../user-guide/harvesting/index.md#Сбор-фрагментов-метаданных-для-повторного-использования)) 
