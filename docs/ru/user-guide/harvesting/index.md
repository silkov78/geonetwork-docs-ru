...
существует настройка, которая позволит это сделать. См. [Импорт метаданных](../../administrator-guide/configuring-the-catalog/system-configuration.md#импорт-метаданных) для получения более подробной информации.
