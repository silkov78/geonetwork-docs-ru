...
Прежде чем начинать настройку прав доступа стоит ознакомиться с разделом [Пользователи, группы и роли](../../administrator-guide/managing-users-and-groups/index.md#пользователи-группы-и-роли) в разделе «Администрирование пользователей и групп» данного руководства.
