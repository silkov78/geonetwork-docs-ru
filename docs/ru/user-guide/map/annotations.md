...
!!! info "Внимание"
    Для аннотаций типа Маркер в 3D-навигации также доступен тип символа *3D-модель*, как показано в разделе [Стилизация в 3D](annotations.md#аннотации-в-3d-навигации) ниже.
