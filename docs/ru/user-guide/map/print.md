...
Карту можно распечатать, выбрав кнопку **Печать** <img src="../img/button/print2.jpg" class="ms-docbutton"  style="max-height:20px;"/> на [Боковой панели инструментов](mapstore-toolbars.md#side-toolbar). Процесс печати состоит из двух основных этапов:
