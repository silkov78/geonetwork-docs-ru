...
* **Редактировать конфигурацию карты** позволяет [настроить карту](configure-map.md).
...
Описательная панель позволяет размещать описательный контент, такой как *текст*, *изображение*, *видео* или *карта* для различных карточек, составляющих секцию "Гео-карусель". Редактор истории может настраивать ее с помощью **панели инструментов контента**, как объясняется в разделе [Контент](immersive-section.md#Контент).
