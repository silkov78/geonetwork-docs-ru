...
При нажатии на кнопку **Продольный профиль** <img src="../img/button/long-profile-button.jpg" class="ms-docbutton"/>, доступную на [Боковой панели инструментов](mapstore-toolbars.md#side-toolbar), открывается выпадающее меню, в котором пользователь может управлять доступными опциями, включая различные способы расчета профиля:
