...
После того как пользователь открывает карту, инструменты *Виды карты* можно открыть с помощью кнопки <img src="../img/button/map-views-button.jpg" class="ms-docbutton" /> на [Боковой панели инструментов](mapstore-toolbars.md#side-toolbar).
...
* Добавлять текст, изображения, видео или гиперссылки через раздел **Описание**. *Описание* видно во время [Навигации по видам](map-views.md#3d-views-navigations). Взгляните на следующий пример.
...
* Изменять длительность анимации и включать/отключать эффект перехода во время [Навигации по видам](map-views.md#3d-views-navigations) с помощью раздела **Анимация**.
...
* Выбирать, какой слой должен быть видим, когда вид активен, через раздел **Опции слоя**. В 2D режиме пользователь может просто включать или отключать все слои, присутствующие в [Содержании](toc.md#table-of-contents), и изменять прозрачность.
