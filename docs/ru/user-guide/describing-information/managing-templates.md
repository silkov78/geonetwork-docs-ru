...
- Управлять шаблонами в каталоге так же, как и записями метаданных, используя специальный тег `template`.
    ...
    ![](img/template-tag.png)
    *Добавлен тег `template`*

- Создавать, обновлять и удалять шаблоны с помощью раздела `Редактирование`.

    ![](img/editing-templates.png)
    *Страница редактирования шаблонов*
...
Для дальнейшей настройки можно улучшить плагин схемы, определив пользовательскую документацию, рекомендуемые значения и т.д. (см. [Реализация плагинов схемы](***.md))
или создав собственное представление (см. [Редактор настройки](***.md)).
