...
!!! note "Примечание"
    ...
    В качестве поисковой системы в Каталоге метаданных используется Elasticsearch - одна из самых популярных поисковых систем в области Big Data, масштабируемое нереляционное хранилище данных с открытым исходным кодом, аналитическая NoSQL-СУБД с широким набором функций полнотекстового поиска.
