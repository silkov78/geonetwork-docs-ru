...
Рэкамендуецца ўвайсці ў сістэму з гэтымі ўліковымі дадзенымі непасрэдна пасля завяршэння ўстаноўкі і змяніць пароль па змаўчанні.
...
Калі ў браўзеры няма актыўнасці і сеанс падыходзіць да канца, за 3 хвіліны да заканчэння часу чакання побач з дадзенымі карыстальніка адлюстроўваецца папярэджанне:
...
Спалучэнне **ролі** і **групы** вызначае, якія задачы Карыстальнік можа выконваць у сістэме або з канкрэтнымі запісамі метададзеных.
...
і змяняць новыя запісы метададзеных, а таксама выкарыстоўваць усе функцыі, даступныя зарэгістраванаму карыстальніку.
...
1. **Адміністратар (каталога)**
    ...
    - Поўныя правы на стварэнне/рэдагаванне/выдаленне новых/старых метададзеных.
...
3. **Рэцэнзент**
    ...
    на публікацыю метададзеных ва ўнутранай сетцы і/або ў Інтэрнэце:

    - Правы на прагляд зместу метададзеных у сваіх групах і дазвол на іх зацвярджэнне і публікацыю.

4. **Рэдактар**

    Рэдактар працуе з метададзенымі з наступнымі прывілеямі:

    - Поўныя правы на стварэнне/рэдагаванне/выдаленне новых/старых дадзеных у сваіх групах.
...
5. **Профіль зарэгістраванага карыстальніка**
    ...
    - Права на загрузку абароненых дадзеных.