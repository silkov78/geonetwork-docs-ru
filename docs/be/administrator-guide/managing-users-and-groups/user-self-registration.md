...
Калі адбываецца самарэгістрацыя карыстальніка, ён атрымлівае ліст з дадзенымі новага ўліковага запісу, які выглядае прыкладна наступным чынам:
...
Калі трэба змяніць змесціва гэтага ліста, вам варта мадыфікаваць `xslt/service/account/registration-pwd-email.xsl`.
    ...
    Паважаны адміністратар,
        ...
        Рэгістрацыйныя дадзеныя карыстальніка:
