...
!!! note "Заўвага"
    ...
    Наладка гэтых параметраў крытычна важная для працы каталога. Няправільнае выкарыстанне некаторых наладак можа прывесці да таго, што сістэма будзе працаваць не так, як чакалася.
...
- **Спіс formatter'аў для экспарту запісаў**: Вызначае фарматаванне, якое выкарыстоўваецца для адлюстравання вынікаў пошуку. 
  Глядзіце [Наладка праглядаў метададзеных](../../customizing-application/creating-custom-view.md) для атрымання інфармацыі 
...
- **Адпаведныя тыпы метададзеных запыту**: Выкарыстоўвайце гэты раздзел для вызначэння тыпаў метададзеных, якія адлюстроўваюцца пры адлюстраванні вынікаў пошуку ў табліцы. 
...
- **Дазволіць карыстальнікам захоўваць карты як запіс метададзеных**: Гэта опцыя дазваляе карыстальнікам захоўваць слаі 
...
- **Арыентацыя старонкі**: Выберыце адзін з варыянтаў макета старонкі `дадаць новыя метададзеныя`. 
...
- **Канфігурацыя фасетаў**: Гэта канфігурацыя выкарыстоўваецца для адлюстравання згрупаваных фасетаў метададзеных. 
