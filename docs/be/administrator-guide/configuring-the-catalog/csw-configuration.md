...
- **Запіс для наладкі адказу GetCapabilities**: Выберыце запіс, які будзе выкарыстоўвацца для наладкі адказу GetCapabilities. 
  Калі такога няма, стварыце запіс метададзеных сэрвісу (выкарыстоўваючы стандарты ISO19139 або 19115-3). 
...
- **Устаўленыя метададзеныя з'яўляюцца агульнадаступнымі**: Па змаўчанні метададзеныя, устаўленыя з дапамогай аперацый збору дадзеныхCSW і транзакцый CSW, 
  недаступныя для публічнага прагляду. Карыстальнік з адпаведнымі правамі доступу можа зрабіць гэта пасля аперацый збору дадзеныхCSW і транзакцый CSW, 
  але гэта не заўсёды зручна. Калі гэты параметр усталяваны, усе метададзеныя, устаўленыя з дапамогай аперацый збору дадзеныхCSW і транзакцыі CSW, 
...
## Запіс сэрвісных метададзеных 

Для стварэння карыстальніцкіх магчымасцей рэкамендуецца стварыць спецыяльны запіс службовых метададзеных (выкарыстоўваючы стандарты ISO19115-3 або ISO19139). 
...
- мова метададзеных (+ дадатковыя мовы, калі такія ёсць) (выкарыстоўваецца для падтрымліваемых моў, мова па змаўчанні)
- Тэмы для натхнення
- часавы ахоп
- кантакты па метададзеных
- адпаведнасць метададзеных рэгламенту Камісіі 1089/2010
