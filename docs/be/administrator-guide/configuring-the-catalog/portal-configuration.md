...
- Зборшчыкі даных (харвестары). Пры зборы даных з іншага вузла парталаў на аснове GeoNetwork таксама збіраюцца даныя з мэтавага каталога, 
  каб адсочваць сапраўднае паходжанне запісаў. Гэта адносіцца толькі да пратаколаў GeoNetwork, 
  якія выкарыстоўваюць MEF ([Фармат абмену метаданымі (MEF)](../../annexes/mef-format.md)), якія ўтрымліваюць інфармацыю зыходнага каталога.
