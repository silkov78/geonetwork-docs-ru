...
-    **Версія** - Версія GeoNetwork (толькі для чытання). 
...
-    **Актыўныя гіперспасылкі** - Калі сцяжок пастаўлены, GeoNetwork будзе паказваць актыўныя гіперспасылкі ў метаданых.
...
-    **Лакальны рэйтынг** - Калі гэты параметр уключаны, каталог будзе разлічваць ацэнкі карыстальнікаў толькі для метаданых з бягучага вузла 
     (не размеркаваных паміж іншымі вузламі GeoNetwork). Гэта адносіцца толькі да запісаў, сабраных з выкарыстаннем пратакола GeoNetwork.
