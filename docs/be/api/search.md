...
Запыт па любым полі для метададзеных, якія змяшчаюць радок `infrastructure`, з выкарыстаннем сінтаксісу Lucene і з выключэннем шаблонаў метададзеных:
...
Запыт па любым полі для метададзеных, якія змяшчаюць радок `infrastructure`, з выкарыстаннем сінтаксісу Lucene і з выключэннем шаблонаў метададзеных, які вяртае толькі частку інфармацыі:
...
### Запыт па наборах дадзеных

Запыт па наборах дадзеных, загаловак якіх змяшчае радок `infrastructure`, з выкарыстаннем сінтаксісу Lucene і з выключэннем шаблонаў метададзеных:
...
Запыт па наборах дадзеных з датай рэвізіі ў чэрвені 2019 года і з выключэннем шаблонаў метададзеных:
