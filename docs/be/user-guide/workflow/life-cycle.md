...
Запісы метаданых маюць жыццёвы цыкл, у працэсе якога яны праходзяць праз некалькі станаў. Напрыклад, калі запіс:
...
У каталогу ёсць (пашыраемы) набор станаў, якія можа мець запіс метаданых:

- `Невядома (Unknown)` - гэта стан па змаўчанні - пра статус запісу метаданых нічога не вядома.
...
- `Ухвалена (Approved)` - рэцэнзент зместу разгледзеў і ўхваліў запіс метаданых.
- `Адхілена (Rejected)` - спецыяліст па аглядзе зместу прагледзеў і адхіліў запіс метаданых.
...
- калі `Рэцэнзент` змяняе стан запісу (запісаў) метаданых з `Адпраўлена` на `Прынята` або `Адхілена`, уладальнік запісу метаданых атрымлівае апавяшчэнне аб змене статусу па электроннай пошце. Электронны ліст, атрыманы ўладальнікам запісу метаданых, выглядае наступным чынам. Карыстальнік таксама можа ўвайсці ў сістэму і скарыстацца спасылкай, указанай у лісце, каб атрымаць доступ да ўхваленых/адхіленых запісаў. Вось прыклад электроннага ліста, адпраўленага гэтым дзеяннем:
