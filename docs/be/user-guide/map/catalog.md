...
Служба каталогаў для веба (CSW) — гэта [стандарт OGC](https://www.ogc.org/standards), які выкарыстоўваецца для публікацыі і пошуку геапрасторавых дадзеных і звязаных з імі метададзеных у інтэрнэце. Ён апісвае геапрасторавыя службы, такія як Web Map Service (WMS), Web Map Tile Service (WMTS) і гэтак далей...
У цяперашні час падтрымліваюцца толькі схемы метададзеных **Dublin Core**. *Профіль метададзеных ISO пакуль не падтрымліваецца*.
...
* *Сартаваць па*: для атрымання выніку каталога ў парадку ўзрастання або змяншэння можна ўвесці `propertyName` атрыбутаў метададзеных і выбраць жаданы тып сартавання (`ASC` або `DESC`).
...
* *Паказваць шаблон метададзеных*: гэтую опцыю можна ўключыць, калі карыстальнік хоча ўставіць у апісанне слоя тэкст з інфармацыяй з метададзеных.

!!! warning "Папярэджанне"
    Функцыя *Шаблон метададзеных* даступная толькі для **службаў CSW**.

#### Шаблоны метададзеных
...
* *Паказваць шаблон метададзеных* можна ўключыць, калі карыстальнік хоча ўставіць у апісанне слоя тэкст з інфармацыяй з метададзеных.
...
!!! info "Увага"
    Паколькі некаторыя з гэтых службаў не з'яўляюцца стандартнымі, іх выкарыстанне ў розных сістэмах каардынат можа выклікаць праблемы. Таму майце на ўвазе, што змена сістэмы каардынат можа выклікаць праблемы, калі гэтыя слаі знаходзяцца на карце.
