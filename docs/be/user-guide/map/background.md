...
Новую фонавую карту можна дадаць з дапамогай кнопкі <img src="../img/button/+++.jpg" class="ms-docbutton"/> у верхняй частцы галоўнай карткі селектара. Пры выкананні гэтага дзеяння адкрываецца панэль [Каталога](catalog.md#catalog-services) з магчымасцю доступу да *Аддаленых службаў*:
