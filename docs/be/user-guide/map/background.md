...
Пры націску на селектар фонавых карт адлюструецца некалькі мініяцюр. Гэтыя мініяцюры можна выбіраць, каб пераключацца з адной фонавай карты на іншую.
...
Новую фонавую карту можна дадаць з дапамогай кнопкі <img src="img/button/+++.jpg" class="ms-docbutton"/> у верхняй частцы галоўнай карткі селектара. Пры выкананні гэтага дзеяння адкрываецца панэль [Каталога](catalog.md) з магчымасцю доступу да *Аддаленых службаў*:

<img src="img/background/bck-catalog.jpg" class="ms-docimage" style="max-width:500px;"/>

!!! warning "Папярэджанне"
    Служба *Фонавыя карты па змаўчанні* даступная толькі пры доступе да [Каталога](catalog.md) з селектара фонавых карт, але калі вы дадасце адтуль новую Аддаленую службу, яна таксама будзе даступная пры доступе да [Каталога](catalog.md) з [Бакавой панэлі інструментаў](mapstore-toolbars.md#бакавая-панэль-інструментаў) або са [Панэлі зместу](toc.md).

З [Каталога](catalog.md) карыстальнік можа выбраць слаі для дадання ў спіс фонавых карт:
...
Пасля выбару опцый, з дапамогай кнопкі <img src="img/button/add_group_confirm_button.jpg" class="ms-docbutton"/> новы фонавы слой будзе канчаткова дададзены ў селектар фонавых карт у выглядзе карткі і аўтаматычна ўсталяваны як бягучы.
...
Адкрыецца акно **Рэдагаваць бягучую фонавую карту**, якое дазваляе карыстальніку наладзіць той жа набор інфармацыі, што і пры даданні новай фонавай карты (гл. [папярэдні раздзел](#даданне-фонавай-карты)).
...
!!! info "Увага"
    Па змаўчанні для новых карт усе фонавыя карты са службы *Фонавыя карты па змаўчанні* дадаюцца ў селектар, і ў [Каталогу](catalog.md) яны адлюстроўваюцца шэрым колерам (нельга дадаць адну і тую ж фонавую карту па змаўчанні двойчы): як толькі вы выдаляеце адну з іх з селектара фонавых карт, яна становіцца даступнай для выбару ў [Каталогу](catalog.md).
