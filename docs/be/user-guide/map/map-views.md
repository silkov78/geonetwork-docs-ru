...
Пасля таго як карыстальнік адкрывае карту, інструменты *Віды карты* можна адкрыць з дапамогай кнопкі <img src="../img/button/map-views-button.jpg" class="ms-docbutton" /> на [Бакавой панэлі інструментаў](mapstore-toolbars.md#side-toolbar).
