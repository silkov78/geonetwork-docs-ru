...
!!! увага
    Для анатацый тыпу Маркер у 3D-навігацыі таксама даступны тып сімвала *3D-мадэль*, як паказана ў раздзеле [Стылізацыя ў 3D](annotations.md#styling-on-3d) ніжэй.
