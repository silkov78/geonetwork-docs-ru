...
Пры націску на кнопку <img src="../img/button/++++.jpg" class="ms-docbutton"/> на [бакавой панэлі інструментаў](exploring-dashboards.md#side-toolbar) адкрываецца панэль *Віджэт*, якая паказвае спіс даступных тыпаў віджэтаў, якія можна дадаць на інфармацыйную панэль:
...
* Перайсці да наступнага кроку з дапамогай кнопкі <img src="../img/button/next.jpg" class="ms-docbutton"/>
...
!!!заўвага
    ...
    * Дадаваць слаі на карту з дапамогай кнопкі <img src="../img/button/+++.jpg" class="ms-docbutton"/>, як паказана ніжэй: <video controls class="ms-docimage"  style="max-width:400px;"><source src="../img/adding-widgets/wid-add-layer.mp4"> /></video>
...
* **Наблізіць** да слаёў з дапамогай кнопкі <img src="../img/button/zoom-layer.jpg" class="ms-docbutton"/>

* Атрымаць доступ да [наладак слоя](layer-settings.md#layer-settings) з дапамогай кнопкі <img src="../img/button/properties.jpg" class="ms-docbutton"/>

* **Выдаліць** слаі з дапамогай кнопкі <img src="../img/button/delete.jpg" class="ms-docbutton"/>

* Адключыць/уключыць [плаваючы інструмент "Ідэнтыфікацыя"](navigation-toolbar.md#floating-identify-tool) для атрымання інфармацыі пра аб'екты слаёў, даступных на карце, з дапамогай кнопкі <img src="../img/button/identify_green_burron.jpg" class="ms-docbutton"/>

!!!увага
    Інструмент *Плаваючая ідэнтыфікацыя* актыўны па змаўчанні (кнопка зялёная).

Пасля націску кнопкі <img src="../img/button/next.jpg" class="ms-docbutton"/>, апошні крок працэсу адлюстроўваецца наступным чынам:

<img src="../img/adding-widgets/map-wid-info.jpg" class="ms-docimage" style="max-width:400px;"/>

Тут у карыстальніка ёсць магчымасць увесці **Загаловак** і **Апісанне** для віджэта (неабавязковыя палі) і завяршыць яго стварэнне, націснуўшы на кнопку <img src="../img/button/save-icon.jpg" class="ms-docbutton"/>. Пасля гэтага віджэт дадаецца ў прастору прагляду:
...
Тут карыстальнік можа вярнуцца <img src="../img/button/back.jpg" class="ms-docbutton"/> да раздзела тыпаў віджэтаў, падключыць <img src="../img/button/connect-widget.jpg" class="ms-docbutton"/> або адключыць <img src="../img/button/connection-icon.jpg" class="ms-docbutton"/> легенду ад карты і перайсці <img src="../img/button/next.jpg" class="ms-docbutton"/> да параметраў віджэта. 
