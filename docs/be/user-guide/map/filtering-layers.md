...
* З дапамогай інструмента *Пашыраны пошук*, даступнага з [Табліцы атрыбутаў](attributes-table.md)

* З дапамогай *Хуткага фільтра*, даступнага ў [Табліцы атрыбутаў](attributes-table.md)
...
Гэты фільтр дазваляе ўсталяваць адну або некалькі ўмоў, якія адносяцца да палёў [Табліцы атрыбутаў](attributes-table.md).
