...
Як адміністратар, вы можаце кіраваць **тэгамі**, выбраўшы опцыю **Кіраваць тэгамі** з меню кнопкі <img src="../img/button/logged.jpg" class="ms-docbutton"/> на хатняй старонцы:
...
* Стварыць **Новы тэг** з дапамогай кнопкі <img src="../img/button/new_tag_button.jpg" class="ms-docbutton"/> і наладзіць яго, дадаўшы *Назву*, *Апісанне* і выбраўшы *Колер* для меткі.
...
* **Рэдагаваць** тэг з дапамогай кнопкі <img src="../img/button/edit_properties.jpg" class="ms-docbutton"/> побач з кожным тэгам у спісе.

* **Выдаліць** тэг з дапамогай кнопкі <img src="../img/button/delete2.jpg" class="ms-docbutton"/> побач з кожным тэгам у спісе.