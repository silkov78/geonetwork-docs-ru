...
На хатняй старонцы карыстальнікі могуць шукаць даступныя рэсурсы з дапамогай **панэлі фільтрацыі**, якая адкрываецца злева на хатняй старонцы па пстрычцы на значок <img src="../img/button/filter_button.jpg" class="ms-docbutton"/>, размешчаны справа ад *інструмента пошуку*.
