...
Калі на карце прысутнічае хаця б адзін слой (дадатковую інфармацыю аб даданні слаёў гл. у раздзеле [Каталог](catalog.md#catalog-services)), можна стварыць віджэт, выбраўшы гэты слой у [Панэлі зместу](toc.md#table-of-contents) і націснуўшы на кнопку <img src="../img/button/widgets.jpg" class="ms-docbutton"/> на [Панэлі інструментаў слоя](toc.md#toolbar-options) або ў [Табліцы атрыбутаў](attributes-table.md#attribute-table). Пасля выканання гэтых дзеянняў з'яўляецца панэль *Віджэт*:
