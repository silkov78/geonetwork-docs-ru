...
Можна ствараць віджэты са слаёў, дададзеных на карту. Віджэты — гэта кампаненты, такія як дыяграмы, тэксты, табліцы і лічыльнікі, карысныя для якаснага і колькаснага апісання і візуалізацыі дадзеных слаёў, а таксама якія прадастаўляюць карыстальніку магчымасць больш эфектыўна аналізаваць інфармацыю.

!!! note "Заўвага"
    Некаторым віджэтам (на картах або ў інфармацыйных панэлях) для працы патрабуецца падтрымка WPS на баку бэкэнда:

    * `віджэты карты` (інфармацыйныя панэлі) маюць патрэбу ў WPS-працэсе `gs:Bounds` для маштабавання да адфільтраваных дадзеных, калі яны звязаны з табліцай.
...
* **Паказаць дадзеныя дыяграмы** ў таблічным прадстаўленні

* **Спампаваць дадзеныя** ў фармаце .csv
