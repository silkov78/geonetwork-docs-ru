...
Некалькі стандартаў падтрымліваюць шматмоўныя метададзеныя (напрыклад, ISO19139, ISO19115-1). Для ISO19139 прадугледжаны шаблон па змаўчанні, але карыстальнік можа дадаць пераклад да існуючага запісу.

Каб аб'явіць новую мову ў запісе метададзеных, трэба:

-  Праверыць асноўную мову, вызначаную ў раздзеле метададзеных.
-  Дадаць адну або некалькі моў у `іншая мова` ў раздзеле метададзеных. 
...
- Пры праглядзе запісу, калі існуе пераклад на мову карыстальніцкага інтэрфейсу, выкарыстоўваецца гэты пераклад; калі не, выкарыстоўваецца асноўная мова метададзеных.
