...
[Тэхнічнага кіраўніцтва па ўкараненні метададзеных набораў дадзеных і сэрвісаў INSPIRE на аснове ISO/TS 19139:2007 (INSPIRE TG2)] (https://inspire.ec.europa.eu/id/document/tg/metadata-iso19139).
...
Дата апошняга абнаўлення метададзеных таксама аўтаматычна абнаўляецца кожны раз, калі рэдактар захоўвае запіс.

## Мовы

Мова метададзеных з'яўляецца абавязковай. Гэта інфармацыя звычайна не мяняецца ў запісах аднаго і таго ж каталога. 
...
**Патрэбен як мінімум адзін пункт у кантакце для рэсурсу і адзін для метададзеных.**

![image](img/inspire-contact.ru.png)

## Ключавыя словы

Пры стварэнні запісу метададзеных рэкамендуецца ствараць ключавыя словы, якія лаканічна апісваюць рэсурс.
...
Павінна быць апісана мінімальнае геаграфічнае абмежаванне набору дадзеных або серыі набораў дадзеных. 
Кампанент карты дазваляе лёгка вызначыць мяжу набору дадзеных. Пры неабходнасці можна вызначыць некалькі межаў.
...
## Метаданыя пра наборы і серыі дадзеных
...
- гісторыя ў раздзеле якасці дадзеных.
...
Таксама можна выкарыстоўваць [апошні стандарт ISO ISO19115-3:2018](https://github.com/metadata101/iso19115-3.2018) для кадзіравання набораў дадзеныхINSPIRE. 
...
Для палягчэння пераходу з папярэдняй версіі тэхнічнага кіраўніцтва 1.3 да запісаў метададзеных можна прымяніць працэс пераўтварэння XSLT (гл. <https://github.com/geonetwork/core-geonetwork/blob/master/schemas/iso19139/src/main/plugin/iso19139/process/inspire-tg13-to-tg20.xsl>). Працэс прыведзены ў якасці прыкладу і можа быць адаптаваны ў адпаведнасці з вашымі правіламі кадзіравання.
