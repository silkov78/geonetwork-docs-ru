...
- Карыстальнікам, які стварыў метададзеныя.
- Карыстальнікам з профілем Reviewer (рэцэнзент) у групе ўладальнікаў метададзеных.
- Адміністратарам
...
У гэтым выпадку DOI можа быць абноўлены. Калі DOI ўжо прысвоены запісу метададзеных, рэдактары таксама могуць абнавіць DOI з рэдактара:
...
Затым DOI дадаецца ў запіс метададзеных:
