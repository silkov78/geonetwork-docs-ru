...
Напрыклад, калі запіс метаданых апісвае некаторы набор геаграфічных даных, аватар-выява можа ўяўляць сабой выяву карты.

Да звязанага рэсурсу можна прывязаць некалькі ілюстрацый.

Ілюстрацыі адлюстроўваюцца ў выніках пошуку і ў прадстаўленні метаданых:
...
- З файла, прымацаванага да метаданых
...
Калі рэсурс даступны ў выглядзе выявы ў Інтэрнэце, яго можна напрамую звязаць з запісам метаданых. 
...
Калі слой WMS зарэгістраваны ў бягучым запісе метаданых (гл. [Звязванне WMS слоя](linking-online-resources.md#linking-wms-layer)), можна стварыць мініяцюру, выкарыстоўваючы яе па-над картай базавага слоя. 
