# Групоўка запісаў метададзеных (сувязь бацька/дзіця) {#linking-parent}

У некаторых сітуацыях апісваемыя дадзеныя могуць мець адну і тую ж спецыфікацыю (напрыклад, глебава-расліннае покрыва за розныя гады) 
і ў сукупнасці ўтвараць калекцыю. Каб згрупаваць такі набор запісаў, агульнае апісанне калекцыі можа быць зроблена ў бацькоўскіх метададзеных. 
Апісанне бацькоўскіх метададзеных затым можа быць прымацавана да ўсіх даччыных запісаў метададзеных. 
...
Націсніце на `Звязаць з бацькам`, каб атрымаць доступ да панэлі, якая прадастаўляе просты пошук для выбару мэтавых бацькоўскіх метададзеных
