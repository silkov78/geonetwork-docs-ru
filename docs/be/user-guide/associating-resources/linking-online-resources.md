...
- `Пратакол` для апісання тыпу прымацаванага дакумента і спосабу перадачы дадзеных(па змаўчанні `Вэб-адрас (URL)`)
...
Для прагляду запісу ў праграме прагляду карт можа спатрэбіцца дадаць спасылку на адзін або некалькі WMS-сэрвісаў, якія публікуюць набор дадзеных. Анлайн-рэсурс кадыруецца наступным чынам у стандарце ISO19139:
...
## Звязванне табліцы базы дадзеных або файла ГІС у сетцы {#linking-online-resources-georesource}

Каб спаслацца на ГІС-файл або табліцу базы дадзеных, карыстальнік можа загрузіць або спаслацца на гэты рэсурс (гл. [Звязванне дакументаў](linking-online-resources.md#linking-online-resources-doc)). Тып пратакола залежыць ад тыпу звязанага рэсурсу:
...
Пры наяўнасці інфармацыі пра базу дадзеных або файл у лакальнай сетцы можа быць дарэчы схаваць гэту інфармацыю для публічных карыстальнікаў (гл. [Абмежаванне інфармацыі да раздзелаў метададзеных](../publishing/restricting-information-to-metadata-sections.md)).

## Звязванне дадзеных з дапамогай ATOM-каналаў {#linking-data-using-atom-feed}

Калі арганізацыя прадастаўляе каналы ATOM для палягчэння доступу да дадзеных, запісы метададзеных могуць спасылацца на гэтыя каналы. Карыстальнікі могуць спасылацца на сэрвісны фід службы і на фід набору дадзеных у запісе набору дадзеных.
...
Пасля рэгістрацыі ў метададзеных стужка ATOM будзе адлюстроўвацца ў прадстаўленні запісу:

![](img/atom-choose-feed.png)

Карыстальнікі могуць выбраць сэрвіс, спіс даступных набораў дадзеных будзе выняты, а спасылкі на спампоўку адлюстраваны карыстальніку. Фід набору дадзеных можа ўтрымліваць адну або некалькі загрузак:
...
Каталог таксама прадастаўляе магчымасць ствараць ATOM-каналы для сэрвісаў і набораў дадзеных на аснове запісаў метададзеных. Набор дадзеныхGML можа быць прадстаўлены ў наступнай кадзіроўцы, каб быць апублікаваным у стужцы дадзеныхATOM:
