...
!!! note "Заўвага"
  ...
  У якасці пошукавай сістэмы ў Каталогу метададзеных выкарыстоўваецца [Elasticsearch](https://www.elastic.co/elasticsearch) - адна з самых папулярных пошукавых сістэм у галіне Big Data, маштабуемае нерэляцыйнае сховішча дадзеных з адкрытым зыходным кодам, аналітычная NoSQL-СУБД з шырокім наборам функцый паўнатэкставага пошуку.
