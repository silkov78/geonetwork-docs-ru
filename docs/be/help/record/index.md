...
Каб даведацца больш падрабязную інфармацыю пра запіс і апісаны набор дадзеных, Вы можаце прагледзець змесціва запісу.
...
2.  Раздзел **Прэв'ю** змяшчае малюнак прасторавага ахопу на міні-карце, які апісвае сапраўднае размяшчэнне дадзеных, якія адносяцца да выбранага запісу.

    ![](img/about.png)
    *Прэв'ю*

3. Раздзел спасылак і фармату - змяшчае спасылкі:
    - на пласты прасторавых дадзеных, даступныя на Нацыянальным геапартале для прагляду ў сродку картаграфічнага прагляду Каталога метададзеных, 
    - на дадзеныя рэсурсу, даступныя для прагляду ў Каталогу карт Нацыянальнага геапартала,
    - фармат дадзеных, якія распаўсюджваюцца дадзеным запісам
...
5. Раздзел **Кантактныя дадзеныя** ўключае звесткі пра ўладальніка, аўтара і пастаўшчыка дадзеных, якія прадстаўляюцца ў выбраным запісе.
...
3.  Укладка **Ідэнтыфікацыя** прадастаўляе:
    ...
    -   Падрабязную кантактную інфармацыю пра ўладальніка, пастаўшчыка і аўтара дадзеных:
...
4.  Укладка **Распаўсюджванне** змяшчае дэталі пра тое, які фармат маюць дадзеныя, а таксама наяўныя спасылкі для доступу да дадзеных, апісваемых у запісе.

    ![](img/data_distribution.png)
    *Дэталі распаўсюджвання дадзеных*
...
6.  Укладка **Метададзеныя** прадастаўляе Карыстальніку:
    ...
    - інфармацыю пра тып рэсурсу, уключаючы спасылку на метададзеныя (прагляд старонкі ў вэб-браўзеры), дату стварэння/рэдакцыі дадзеных, стандарт метададзеных:
