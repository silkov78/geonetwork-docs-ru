...
The immersive content can include text, media contents or web pages. A new content can be added inside the immersive content column through the <img src="../../../ru/user-guide/map/img/button/++++.jpg" class="ms-docbutton"/> button, or it can be removed through the <img src="../../../ru/user-guide/map/img/button/remove2.jpg" class="ms-docbutton"/> button.
...
* Add a media as a background of the section, with the **Change media source** button <img src="../../../ru/user-guide/map/img/button/change-media.jpg" class="ms-docbutton"/> that opens the [Media Editor](media-editor-window.md#media-editor-window)
