...
<img src="../../../ru/user-guide/map/img/web-section/web-window.jpg" class="ms-docimage"/>

Below an example of a Web Page Section that embed a Wikipedia site page:

<img src="../../../ru/user-guide/map/img/web-section/web-page.jpg" class="ms-docimage"/>
...
<img src="../../../ru/user-guide/map/img/web-section/add-section.jpg" class="ms-docimage"/>
