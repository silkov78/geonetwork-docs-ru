...
This filter is applicable from the **Filter layer** button <img src="../../../ru/user-guide/map/img/button/filter-layer.jpg" class="ms-docbutton"/> in TOC's [Layers Toolbar](toc.md#toolbar-options) and it will persist in the following situations:
...
This filter is applied through the [Query Panel](#query-panel). Once the settings are chosen, it is possible to **Apply** <img src="../../../ru/user-guide/map/img/button/apply_button.jpg" class="ms-docbutton"/> them. After that the user can:

* **Undo** <img src="../../../ru/user-guide/map/img/button/undo_button.jpg" class="ms-docbutton"/> the last changes

* **Reset** <img src="../../../ru/user-guide/map/img/button/reset_button.jpg" class="ms-docbutton"/> the filter to the initial situation

* **Save** <img src="../../../ru/user-guide/map/img/button/save_button.jpg" class="ms-docbutton"/> the filter in order to make it persistent
...
After that, the user can insert one or more conditions, that can also be grouped in one or more condition groups (use the <img src="../../../ru/user-guide/map/img/button/condition_group.jpg" class="ms-docbutton"/> button in order to create a group).<br>
...
!!! Note
    ...
    <video class="ms-docimage" style="max-width:500px;" controls><source src="../../../ru/user-guide/map/img/filtering-layers/quick_date_ranges.mp4"/></video>
...
<video class="ms-docimage" controls><source src="../../../ru/user-guide/map/img/filtering-layers/att_filter.mp4"/></video>
...
<video class="ms-docimage" controls><source src="../../../ru/user-guide/map/img/filtering-layers/geom_filter.mp4"/></video>

Once this filter is set, it is always possible to edit the coordinates and the dimensions of the drawn filter's geometry by clicking on the **Details** button <img src="../../../ru/user-guide/map/img/button/edit-icon-1.jpg" class="ms-docbutton"/>. Editing a circle, for example, it is possible to change the center coordinates (*x*, *y*) and the radius dimension (*m*):
...
!!! note
     ...
     <video class="ms-docimage" style="max-width:600px;" controls><source src="../../../ru/user-guide/map/img/filtering-layers/area-filter-dash.mp4"/></video>
...
<img src="../../../ru/user-guide/map/img/filtering-layers/layer-filter-1.jpg" class="ms-docimage"/>
...
<img src="../../../ru/user-guide/map/img/filtering-layers/cascading-search-filter.jpg" class="ms-docimage"/>
