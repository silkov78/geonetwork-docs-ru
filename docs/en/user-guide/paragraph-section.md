...
The Paragraph Section allows to insert a textual content to the story. The story editor can also click on the <img src="../../../ru/user-guide/map/img/button/++++.jpg" class="ms-docbutton"/> button to add additional contents to this section (like media, other paragraphs or embed third party contens). It is possible to choose between:

<img src="../../../ru/user-guide/map/img/paragraph-section/add-paragraph.jpg" class="ms-docimage"/>

* **Text Content** <img src="../../../ru/user-guide/map/img/button/add-text-content.jpg" class="ms-docbutton"/> to add another text content just below the current one

* **Media Content** <img src="../../../ru/user-guide/map/img/button/add-media-content.jpg" class="ms-docbutton"/> to open the Media Editor to add an image, a map or a video.

* **Web Page Content** <img src="../../../ru/user-guide/map/img/button/web_page_button.jpg" class="ms-docbutton"/> to add an external web page
...
* Change the size of the text content: clicking on the **Change Size** button <img src="../../../ru/user-guide/map/img/button/change_size2.jpg" class="ms-docbutton"/> a dropdown menu appears to allow selecting between *Small*, *Medium* or *Full* size:

<img src="../../../ru/user-guide/map/img/paragraph-section/paragraphe-size.jpg" class="ms-docimage"/>

* Delete the *Paragraph  Section* through the **Remove** button <img src="../../../ru/user-guide/map/img/button/remove2.jpg" class="ms-docbutton"/>
