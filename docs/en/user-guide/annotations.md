...
Within the map viewer,  the editor can access the **Annotations** <img src="../../../ru/user-guide/map/img/button/annotations2.jpg" class="ms-docbutton" style="max-height:30px;"/> tool button from the [TOC](toc.md) <img src="../../../ru/user-guide/map/img/button/show-layers.jpg" class="ms-docbutton" style="max-height:30px;"/> panel on the top-left corner of the map viewer.
...
* **Marker** <img src="../../../ru/user-guide/map/img/button/marker2.jpg" class="ms-docbutton" />
* **Line** <img src="../../../ru/user-guide/map/img/button/line2.jpg" class="ms-docbutton" />
* **Polygon** <img src="../../../ru/user-guide/map/img/button/polygon2.jpg" class="ms-docbutton" />
* **Text** <img src="../../../ru/user-guide/map/img/button/text2.jpg" class="ms-docbutton" />
* **Circle** <img src="../../../ru/user-guide/map/img/button/circle2.jpg" class="ms-docbutton" />
...
* For *Line* and *Polygon*, add new vertices using the <img src="../../../ru/user-guide/map/img/button/++.jpg" class="ms-docbutton" /> button and typing the `latitude` and `longitude` values.
...
* **Zoom** to the annotation geometry on map through the <img src="../../../ru/user-guide/map/img/button/zoom_button.jpg" class="ms-docbutton" /> button

* **Delete** the geometry annotation through the <img src="../../../ru/user-guide/map/img/button/delete_button.jpg" class="ms-docbutton" /> button

Once all the geometries are created, the user can go back to the [TOC](toc.md) by clicking the <img src="../../../ru/user-guide/map/img/button/x2.jpg" class="ms-docbutton" /> button. A new annotation layer will appear here.
...
* **Zoom** to annotation extent through the <img src="../../../ru/user-guide/map/img/button/zoom_button.jpg" class="ms-docbutton" /> button

* **Delete** the annotation through the <img src="../../../ru/user-guide/map/img/button/delete_button.jpg" class="ms-docbutton" /> button

* **Edit** the annotation through the <img src="../../../ru/user-guide/map/img/button/edit_button.jpg" class="ms-docbutton" /> button

* **Download** the annotation through the <img src="../../../ru/user-guide/map/img/button/download_annotation_button.jpg" class="ms-docbutton" /> button
...
* The *Mark* type: clicking on the <img src="../../../ru/user-guide/map/img/button/add_mark_button.jpg" class="ms-docbutton"/> button, the Mark symbolizer panel opens.
...
* The *Icon* type: clicking on the <img src="../../../ru/user-guide/map/img/button/add_icon_button.jpg" class="ms-docbutton"/> button, the Icon symbolizer panel opens.
...
The line annotation is also customizable adding a Mark symbolizer by clicking on the <img src="../../../ru/user-guide/map/img/button/add_mark_button.jpg" class="ms-docbutton"/> button or the Icon one with the <img src="../../../ru/user-guide/map/img/button/add_icon_button.jpg" class="ms-docbutton"/> button and choose *Start Point*, *Center* or *End Point* from the `Geometry transformation` option.
...
Also for the polygon itis possible to add a *Mark* <img src="../../../ru/user-guide/map/img/button/add_mark_button.jpg" class="ms-docbutton"/> or an *Icon* <img src="../../../ru/user-guide/map/img/button/add_icon_button.jpg" class="ms-docbutton"/> symbolizer in the same way as for Line annotations.
...
The *Center* of a *Circle* annotation can be also customized by adding a *Mark* <img src="../../../ru/user-guide/map/img/button/add_mark_button.jpg" class="ms-docbutton"/> or an *Icon* <img src="../../../ru/user-guide/map/img/button/add_icon_button.jpg" class="ms-docbutton"/> symbolizer in the same way as Line and polygon annotations.
