...
Elasticsearch needs to be installed and configured (See [Installing search platform](https://docs.geonetwork-opensource.org/4.4/install-guide/installing-index/)).
