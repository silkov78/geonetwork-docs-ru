...
Depending on the view configuration (see [Customizing editor](https://docs.geonetwork-opensource.org/4.4/customizing-application/editor-ui/creating-custom-editor/)), editors can reorder elements using up and down controls.
