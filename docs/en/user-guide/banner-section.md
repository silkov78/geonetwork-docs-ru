...
* Add a media content as a background opening the [Media Editor](media-editor-window.md#media-editor-window) through the **Change media source** button <img src="../../../ru/user-guide/map/img/button/change-media.jpg" class="ms-docbutton"/> and choose between images, videos or maps.
...
* Remove the banner section through the **Remove** button <img src="../../../ru/user-guide/map/img/button/remove-button-banner.jpg" class="ms-docbutton"/>
